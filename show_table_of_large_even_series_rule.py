...
def stringify_header():
    ...
    +-------------+-------------+----------+----------+--------+-----------+-----------------------------------------------------------------------------------------------------------------------+
    | p           | Failure     | p_step   | q_step   | span   | longest   | Total ab (of players)             ____________________________________________________________________________________|
    ...
    # CSV
    text = f"""\
p=,p,％ f=,failure_rate,％ 表=,p_step,裏=,q_step,目=,span,最長=,longest,局 計=,total_ab,シリ Ａ勝=,wins_a,シリ Ｂ勝=,wins_b,シリ 成功=,succ,シリ Ａ満点=,ful_wins_a,シリ Ｂ満点=,ful_wins_b,シリ 失敗=,fail,シリ Ａ点差勝=,pts_wins_a,シリ Ｂ点差勝=,pts_wins_b,シリ 無勝負=,no_wins_ab,シリ\
"""
...
#+-------------+-------------+----------+----------+--------+-----------+-----------------------------------------------------------------------------------------------------------------------+
#| t1          | t2          | t3       | t4       | t5     | t6        | t17                               ____________________________________________________________________________________|
...
#-------------+-------------+----------+----------+--------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+
    ...
    # CSV
    text = f"""\
p=,{ t1},％ f=,{ t2},％ 表=,{ t3},裏=,{ t4},目=,{ t5},最長=,{ t6},局 計=,{t17},シリ Ａ勝=,{t18},シリ Ｂ勝=,{t19},シリ 成功=,{ t8},シリ Ａ満点=,{t20},シリ Ｂ満点=,{t21},シリ 失敗=,{ t9},シリ Ａ点差勝=,{t22},シリ Ｂ点差勝=,{t23},シリ 無勝負=,{t24},シリ\
"""
