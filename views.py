...
def print_when_generate_even_when_alternating_turn(is_automatic, p, best_new_p, best_new_p_error, best_round_count, points_configuration):
...
def print_when_generate_when_frozen_turn(is_automatic, p, best_new_p, best_new_p_error, best_round_count, points_configuration):
