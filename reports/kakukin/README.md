...
```
               １局目               ２局目   結果
               ------              -------  -----------------
1 --+-->Ａ(表)  0.54 --+-->Ｂ(表)   0.2916   ３局目に続く
    |                  |
    |                  +-->Ａ(裏)   0.1944   達成でＡさんの勝ち
    |                  |
    |                  +-->失       0.054    ３局目に続く
    |
    +-->Ｂ(裏)  0.36                0.36     達成でＢさんの勝ち
    |
    +-->失      0.1  --+-->Ｂ(表)   0.054    ３局目に続く
                       |
                       +-->Ａ(裏)   0.036    達成でＡさんの勝ち
                       |
                       +-->失       0.01     ３局目に続く
...
```
               １局目              ２局目                 ３局目      結果
               ------              -------               --------   -----------------
1 --+-->Ａ(表)  0.54 --+-->Ｂ(表)   0.2916 --+-->Ａ(表)   0.157464   達成でＡさんの勝ち
    |                  |                    |
    |                  |                    +-->Ｂ(裏)   0.104976   達成でＢさんの勝ち
    |                  |                    |
    |                  |                    +-->失       0.02916    ４局目に続く
    |                  |
    |                  +-->Ａ(裏)   0.1944               0.1944     達成でＡさんの勝ち
    |                  |
    |                  +-->失       0.054  --+-->Ａ(表)   0.02916    達成でＡさんの勝ち
    |                                        |
    |                                        +-->Ｂ(裏)   0.01944    達成でＢさんの勝ち
    |                                        |
    |                                        +-->失       0.0054     ４局目に続く
    |
    +-->Ｂ(裏)  0.36                0.36                  0.36       達成でＢさんの勝ち
    |
    +-->失      0.1  --+-->Ｂ(表)   0.054  --+-->Ａ(表)   0.02916    ４局目に続く
                       |                     |
                       |                     +-->Ｂ(裏)   0.01944    達成でＢさんの勝ち
                       |                     |
                       |                     +-->失       0.0054     ４局目に続く
                       |
                       +-->Ａ(裏)   0.036                 0.036      達成でＡさんの勝ち
                       |
                       +-->失       0.01   --+-->Ａ(表)   0.0054     ４局目に続く
                                             |
                                             +-->Ｂ(裏)   0.0036     達成でＢさんの勝ち
                                             |
                                             +-->失       0.001      ４局目に続く
...
```
               １局目               ２局目                 ３局目                   ４局目      結果
               ------              -------                ---------               ---------   --------------------
1 --+-->Ａ(表)  0.54 --+-->Ｂ(表)   0.2916 --+-->Ａ(表)    0.157464                0.157464    達成でＡさんの勝ち
    |                  |                     |
    |                  |                     +-->Ｂ(裏)   0.104976                0.104976    達成でＢさんの勝ち
    |                  |                     |
    |                  |                     +-->失       0.02916   --+-->Ｂ(表)  0.0157464    達成でＢさんの勝ち
    |                  |                                              |
    |                  |                                              +-->Ａ(裏)  0.0104976    達成でＡさんの勝ち
    |                  |                                              |
    |                  |                                              +-->失      0.002916    勝者なし
    |                  |
    |                  +-->Ａ(裏)   0.1944                0.1944                  0.1944       達成でＡさんの勝ち
    |                  |
    |                  +-->失       0.054  --+-->Ａ(表)   0.02916                 0.02916      達成でＡさんの勝ち
    |                                        |
    |                                        +-->Ｂ(裏)   0.01944                 0.01944      達成でＢさんの勝ち
    |                                        |
    |                                        +-->失       0.0054    --+-->Ｂ(表)  0.002916     勝者なし
    |                                                                 |
    |                                                                 +-->Ａ(裏)  0.001944     達成でＡさんの勝ち
    |                                                                 |
    |                                                                 +-->失      0.00054      勝ち点差でＡさんの勝ち
    |
    +-->Ｂ(裏)  0.36                0.36                  0.36                    0.36         達成でＢさんの勝ち
    |
    +-->失      0.1  --+-->Ｂ(表)   0.054  --+-->Ａ(表)   0.02916   --+-->Ｂ(表)   0.0157464    達成でＢさんの勝ち
                       |                     |                       |
                       |                     |                       +-->Ａ(裏)   0.0104976    達成でＡさんの勝ち
                       |                     |                       |
                       |                     |                       +-->失       0.002916     勝者なし
                       ...
                       |                     +-->Ｂ(裏)   0.01944                 0.01944      達成でＢさんの勝ち
                       |                     |
                       |                     +-->失       0.0054    --+-->Ｂ(表)  0.002916     達成でＢさんの勝ち
                       |                                              |
                       |                                              +-->Ａ(裏)  0.001944     達成でＡさんの勝ち
                       |                                              |
                       |                                              +-->失      0.00054      勝ち点差でＢさんの勝ち
                       |
                       +-->Ａ(裏)   0.036                 0.036                   0.036        達成でＡさんの勝ち
                       |
                       +-->失       0.01   --+-->Ａ(表)   0.0054    --+-->Ｂ(表)  0.002916      勝者なし
                                             |                        |
                                             |                        +-->Ａ(裏)  0.001944      達成でＡさんの勝ち
                                             |                        |
                                             |                        +-->失      0.00054       勝ち点差でＡさんの勝ち
                                             |
                                             +-->Ｂ(裏)   0.0036                  0.0036        達成でＢさんの勝ち
                                             |
                                             +-->失       0.001     --+-->Ｂ(表)  0.00054       勝ち点差でＢさんの勝ち
                                                                      |
                                                                      +-->Ａ(裏)  0.00036       達成でＡさんの勝ち
                                                                      |
                                                                      +-->失      0.0001        勝者なし
