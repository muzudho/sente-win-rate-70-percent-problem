...
from library import HEAD, TAIL, ALICE, SUCCESSFUL, FACE_OF_COIN, FROZEN_TURN, ALTERNATING_TURN, ALICE_FULLY_WON, BOB_FULLY_WON, ALICE_POINTS_WON, BOB_POINTS_WON, NO_WIN_MATCH, Specification, SeriesRule, judge_series, Converter, SequenceOfFaceOfCoin, ScoreBoard
...
if __name__ == '__main__':
    ...
    try:
        ...
        csv_file_path = ScoreBoardFilePaths.as_csv(
                ...
                h_step=specified_series_rule.get_h_step,
                t_step=specified_series_rule.get_t_step,
        ...
        def on_score_board_created(score_board):
            ...
            csv_file_path = ScoreBoardFilePaths.as_csv(
                    ...
                    h_step=score_board.series_rule.h_step,
                    t_step=score_board.series_rule.t_step,
