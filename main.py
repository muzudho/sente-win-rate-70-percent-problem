...
if __name__ == '__main__':
    ...
    try:
        ...
        rule_list = [
            ...
            [0.52, 0.0119, 45, 2_000_000, 22],  # r2_000_000 [0.0193  1本  1黒  1白][0.0155 43本 23黒 21白][0.0119 45本 24黒 22白]  （自動計算満了）
            ...
            [0.60, 0.0121, 19, 2_000_000,  8],  # r2_000_000 [0.1001  1本  1黒  1白][0.0800  7本  5黒  3白][0.0174  9本  6黒  4白][0.0121 19本 12黒  8白]  （自動計算満了）
            ...
            [0.67, 0.0174, 14, 2_000_000,  5],  # r2_000_000 [0.1707  1本  1黒  1白][0.0509  2本  2黒  1白][0.0328  5本  4黒  2白][0.0241  8本  6黒  3白][0.0178 11本  8黒  4白][0.0133 14本 10黒  5白]  （自動計算満了）
            ...
            [0.75, 0.0131, 34, 2_000_000,  9],  # r2_000_000 [0.2505  1本  1黒  1白][0.0623  2本  2黒  1白][0.0553  7本  6黒  2白][0.0256 10本  8黒  3白][0.0194 18本 14黒  5白][0.0150 26本 20黒  7白][0.0131 34本 26黒  9白]  （自動計算満了）
            ...
            [0.90, 0.0104, 26, 2_000_000,  3],  # r2_000_000 [0.3998  1本  1黒  1白][0.3096  2本  2黒  1白][0.2298  3本  3黒  1白][0.1564  4本  4黒  1白][0.0903  5本  5黒  1白][0.0312  6本  6黒  1白][0.0211  7本  7黒  1白][0.0183 17本 16黒  2白][0.0104 26本 24黒  3白]  （自動計算満了）
            ...
            [0.93, 0.0139, 23, 2_000_000,  2],  # r2_000_000 [0.4299  1本  1黒  1白][0.3652  2本  2黒  1白][0.3044  3本  3黒  1白][0.2480  4本  4黒  1白][0.1955  5本  5黒  1白][0.1471  6本  6黒  1白][0.1013  7本  7黒  1白][0.0599  8本  8黒  1白][0.0200  9本  9黒  1白][0.0157 10本 10黒  1白][0.0139 23本 22黒  2白]  （自動計算満了）
        ...
        for rule in rule_list:
            ...
            if is_automatic:
                ...
                # ｎ本勝負
                #
                #   NOTE バイナリーサーチにしたいが、［同じ比のスキップ］を小さい本数順にするのが大変だから、そうしてない
                #
