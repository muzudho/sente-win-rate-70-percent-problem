...
class GeneratorOneOfTPB():
    ...
    def get_best_tptpr_record_or_none(self):
        ...
        result_set_df = self._tptpr_df.loc[abs(self._tptpr_df['expected_a_victory_rate_by_duet'] - 0.5) == min(abs(self._tptpr_df['expected_a_victory_rate_by_duet'] - 0.5))]
        ...
        if 0 < len(result_set_df):
            ...
            return TpTprRecord(
                    ...
                    expected_a_victory_rate_by_duet=result_set_df['expected_a_victory_rate_by_duet'][index],
    ...
    def _on_match_tptpr_record(self, tptpr_record):
        ...
        old_expected_a_victory_rate_by_duet = self._tptpr_df['expected_a_victory_rate_by_duet'][tp_index]                 # 例： 0.5232622375064023
        ...
        welcome_theoretical_a_win_error = tptpr_record.expected_a_victory_rate_by_duet - EVEN           # 例： 0.51

        # 誤差が縮まれば更新
        if abs(welcome_theoretical_a_win_error) < abs(old_expected_a_victory_rate_by_duet - EVEN):
            shall_upsert_record = True

        # 誤差が同じでも、引分け率が新しく判明したか、引き分け率が下がれば更新
        elif welcome_theoretical_a_win_error == abs(old_expected_a_victory_rate_by_duet - EVEN) and (old_expected_no_win_match_rate is None or tptpr_record.expected_no_win_match_rate < old_expected_no_win_match_rate):
            shall_upsert_record = True
        ...
        if shall_upsert_record:
            ...
            welcome_record = TheoreticalProbabilityBestRecord(
                    ...
                    expected_a_victory_rate_by_duet=tptpr_record.expected_a_victory_rate_by_duet,
