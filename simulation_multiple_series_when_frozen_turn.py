#
# シミュレーション
# python simulation_multiple_series_when_frozen_turn.py
#
#   ［先後固定制］
#   引き分けは考慮していない。
...
from library import BLACK, ALICE, PointsConfiguration, make_cointoss_list, play_series_when_frozen_turn, SimulationResult
