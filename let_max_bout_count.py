...
if __name__ == '__main__':
    ...
    try:
        ...
        # max_number_of_bout_in_freeze_turn = round_letro(1/(1-expected_black_win_rate)-1)    # ※小数点以下四捨五入
        # print(f"[{datetime.datetime.now()}] {expected_black_win_rate=}  {max_number_of_bout_in_freeze_turn=}")
